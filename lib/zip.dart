...
class Archive {
  ...
  // End of Central Directory Record
   _EndOfCentralDirectoryRecord end = new _EndOfCentralDirectoryRecord(
     number_of_entries: files.length,
     total_number_of_entries_in_central_directory: files.length,
     size_of_the_central_directory: centralDirSize,
     offset_of_start_of_central_directory_with_respect_to_the_starting_disk_number: centralDirOffset
   );
  ...
  Archive.raw(Uint8List bytes) {
    ...
    if(offset.offset == data.lengthInBytes)
      return;
  ...
  File addFile(String name, Uint8List data) {
    ...
    files.add(f);
    _CentralDirectoryHeader header = new _CentralDirectoryHeader(
